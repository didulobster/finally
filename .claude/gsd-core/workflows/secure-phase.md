...
```
Agent(
  prompt="Read /Users/wilsonsmacmini/Documents/Code/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/wilsonsmacmini/Documents/Code/finally/.claude/gsd-core/templates/SECURITY.md`
