...
**Verification depth scales with `asvs_level`** (see @/Users/wilsonsmacmini/Documents/Code/finally/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
