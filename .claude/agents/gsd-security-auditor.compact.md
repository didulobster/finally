...
**Verification depth scales with `asvs_level`** (full definitions: @/Users/wilsonsmacmini/Documents/Code/finally/.claude/gsd-core/references/security-asvs-levels.md):
